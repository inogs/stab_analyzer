...
contains
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      ...
      _LOOP_BEGIN_
         ...
         grazingP2 = - C1 * ( self%aP2C1*P2 / (1.0+self%bP1C1*P1+self%bP2C1*P2+self%bP3C1*P3) ) - C2 * ( self%aP2C2*P1 / (1.0+self%bP1C2*P1+self%bP2C2*P2+self%bP3C2*P3) )  
         grazingP3 = - C1 * ( self%aP3C1*P1 / (1.0+self%bP1C1*P1+self%bP2C1*P2+self%bP3C1*P3) ) - C2 * ( self%aP3C2*P1 / (1.0+self%bP1C2*P1+self%bP2C2*P2+self%bP3C2*P3) )  
